...
public class TheSecondSimCard {
    private String name;
    private String yourNumber;
    private double balance;

    public TheSecondSimCard(String name, String yourNumber, double balance) {
        this.name = name;
    ...
    public void balanceWithdrawal2(String operation) {
    ...
    public void megaComeReplenishmentOfTheBalance50() {
        this.balance += 50;
        System.out.println("the balance is replenished! megaCome");
        System.out.println("your balance right now:" + this.balance);
    }

    @Override
    public String toString() {
        return " name: " + name + ", Your number: " + yourNumber +
                ", balance: " + balance;
    }
}
